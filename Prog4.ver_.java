...
public class Prog4 {
    ...
    *------------------------------------------------------------------------*/
    private static void loopMechanism(Connection conn) {
        ...
        String help = "Enter 'exit' to exit the program, 'help' to repeat "+
            "this message, 'functionalities_<1/2>' for functionality options,"+
        ...
        System.out.println("   <> Syntax Example: 'functionalities_1' is acceptable, 'functionalities_<1/2>' is not.");
        System.out.println("   Also, all '' represent string contents. You should not actually type these out.");
        System.out.println("   Additionally, command args are broken up by the '_' chars to support multi-word args.");
        System.out.println("");
        ...
        while (loopRun == true) {
            ...
            if (query.contentEquals("exit"))
                ...
                System.out.println(help);
            else if (query.contentEquals("functionalities_1"))
                printFunctionalities(1);
            else if (query.contentEquals("functionalities_2"))
    ...
    *------------------------------------------------------------------------*/
    private static void printFunctionalities(int page) {
        if (page == 1) {
            ...
            System.out.println("      create user: 'user.create_<string NAME>_<string EMAIL>_<string LANGUAGE>_<int TIER>'");
            System.out.println("      change user information: 'user.change_<int USERID>_<'name'/'email'/'language'/'tierId'>_<string NEW VALUE>_<int NEW TIER>'");
            System.out.println("      delete user: 'user.delete_<int USERID>'");
            System.out.println("   CONVERSATION...");;
            System.out.println("      add msg to convo: 'convo.add_<int CONVOID>_<string MESSAGE>'");
            System.out.println("      add feedback to msg: 'convo.feedback_<int MESSAGEID>_<int RATING>_<string FEEDBACK>'");
            System.out.println("   WORKSPACE...");
            System.out.println("      create workspace: 'workspace.create_<int USERID>_<string NAME>'");
            System.out.println("      change workspace name: 'workspace.change_<int WORKSPACEID>_<string NEW NAME>'");
            System.out.println("      add convo to workspace: 'workspace.add_<int USERID>_<int PERSONAID>_<int WORKSPACEID>_<string TITLE>'");
            System.out.println("   PERSONA...");
            System.out.println("      create persona: 'persona.create_<string NAME>_<string DIRECTIVE>'");
            System.out.println("      delete persona: 'persona.delete_<int PERSONAID>'");
            System.out.println("~ ~ ~");
            System.out.println("");
        } else if (page == 2) {
            System.out.println("");
            ...
            System.out.println("      create template: 'template.create_<string TITLE>_<string CONTENT>_<int USERID>_<int WORKSPACEID>'");
            System.out.println("      change template: 'template.change_<int TEMPLATEID>_<'title'/'content'>_<string NEW VALUE>'");
            System.out.println("   SUBSCRIPTION...");
            System.out.println("      change subscription: 'subscription.change_<int USERID>_<int NEW TIER>'");
            System.out.println("   INVOICE...");
            System.out.println("      create invoice: 'invoice.create_<int USERID>_<double AMOUNT>'");
            System.out.println("      pay invoice: 'invoice.pay_<int INVOICEID>'");
            System.out.println("   TICKET...");
            System.out.println("      open ticket: 'ticket.open_<int USERID>_<int AGENTID>_<string TOPIC>'");
            System.out.println("      close ticket: 'ticket.close_<int TICKETID>_<int NUMBER OF MINUTES TAKEN>'");
            System.out.println("~ ~ ~");
            System.out.println("");
        }
        System.out.println("EXAMPLE: 'user.change_2_language_mandarin_5' (Note: as language is chosen, 5 is ignored)");
        System.out.println("");
    }
    ...
    *------------------------------------------------------------------------*/
    private static void printQueries() {
        ...
        System.out.println("      'query1_<int USERID>'");
        ...
        System.out.println("      'query4_<int USERID>'");
        System.out.println("~ ~ ~");
        System.out.println("");
        System.out.println("EXAMPLE: 'query4_1'");
        System.out.println("");
    }
