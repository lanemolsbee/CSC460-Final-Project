...
CREATE TABLE conversation(
    ...
    FOREIGN KEY (workspaceId) REFERENCES workspace,
...
CREATE TABLE FEEDBACK(
    mesageId INT PRIMARY KEY NOT NULL,
    rating INT NOT NULL,
    feedback TEXT,
...
CREATE TABLE BOOKMARK(
    ...
    FOREIGN KEY (userId) REFERENCES user,
    FOREIGN KEY (messageId) REFERENCDES message
);
...
CREATE TABLE supportTicket(
    ...
    FOREIGN KEY (userId) REFERENCES user,
    FOREIGN KEY (agentId) REFERENCES user
);
...
INSERT INTO user VALUES (1, 'Alice Johnson', 'alice@example.com', CURRENT_TIMESTAMP, 'English', 2);
INSERT INTO user VALUES (2, 'Bob Smith', 'bob@example.com', CURRENT_TIMESTAMP, 'English', 1);
INSERT INTO user VALUES (3, 'Charlie Lee', 'charlie@example.com', CURRENT_TIMESTAMP, 'Spanish', 3);
INSERT INTO user VALUES (4, 'Dana White', 'dana@example.com', CURRENT_TIMESTAMP, 'French', 2);\
...
--Sample data for workspace memberships
...
--Sample data for billing profiles
