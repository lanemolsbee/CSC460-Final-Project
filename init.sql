...
GRANT SELECT, INSERT, UPDATE, DELETE ON feedback TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON agent TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON bookmark TO PUBLIC;
